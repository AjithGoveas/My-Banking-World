...
class TransactionManager:
    transaction_log = []
    log_file = "services/transaction_log.json"
    ...
    def input_transaction(cls):
        ...
        # Prompt for transaction type (Deposit/Withdraw/Transfer)
    ...
    def get_transactions_by_type(cls, account_number, transaction_type):
        ...
        if not os.path.exists(cls.log_file):
            raise AccountDoesNotExistsException(f"No transactions found for account {account_number}.")
        ...
        try:
            ...
            if not filtered_transactions:
                raise AccountDoesNotExistsException(f"No transactions of type '{transaction_type}' found for account {account_number}.")
